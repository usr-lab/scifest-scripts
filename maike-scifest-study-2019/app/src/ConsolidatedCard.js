...
export default class ConsolidatedCard extends React.Component {
            ...
            <ul style={{fontSize: 14, fontWeight: 500, listStyle: 'None', paddingLeft: 0, marginBottom: 0}}>
              <li style={{fontSize: 14, fontWeight: 500, color: '#454545'}}>Hyra <b
                style={{
                  fontWeight: 500,
                  color: '#000000'
                }}>{this.props.rent[0]} - {this.props.rent[this.props.rent.length - 1]} SEK</b></li>
              <li style={{fontSize: 14, fontWeight: 500, color: '#454545', marginTop: 4}}>Rum <b
                style={{
                  fontWeight: 500,
                  color: '#000000'
                }}>{this.props.rooms[0]} - {this.props.rooms[this.props.rooms.length - 1]} rum och kök</b>
              </li>
              <li style={{fontSize: 14, fontWeight: 500, color: '#454545', marginTop: 4}}>Kvm <b
                style={{
                  fontWeight: 500,
                  color: '#000000'
                }}>{this.props.area[0]} - {this.props.area[this.props.area.length - 1]} kvm</b></li>
            </ul>
          </CardText>
